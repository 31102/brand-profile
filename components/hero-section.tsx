  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/qatar-skyline-with-modern-buildings-and-traditiona.png" alt="Qatar Skyline" className="w-full h-full object-cover" />
          ...
          >
            <div className="space-y-4">
              <motion.div
                ...
                className={`flex flex-wrap gap-2 ${language === "ar" ? "justify-end" : ""}`}
              >
            ...
            >
              <div className={`text-center ${language === "ar" ? "font-arabic" : ""}`}>
                ...
                <div className="text-sm text-white/80">{language === "ar" ? "سنة خبرة" : "Years Experience"}</div>
              </div>
              <div className={`text-center ${language === "ar" ? "font-arabic" : ""}`}>
                <div className="flex justify-center mb-2">
                ...
                <div className="text-sm text-white/80">{language === "ar" ? "شراكة" : "Partnerships"}</div>
              </div>
              <div className={`text-center ${language === "ar" ? "font-arabic" : ""}`}>
                <div className="flex justify-center mb-2">
                ...
                <div className="text-sm text-white/80">{language === "ar" ? "مشروع" : "Projects"}</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <div className={`text-xs opacity-80 ${language === "ar" ? "font-arabic" : ""}`}>
